...
export const launchpadsRouter = createTRPCRouter({
  // Public: Get many launchpads (với filtering)
  ...
  purchase: protectedProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      ...
      console.log("existingOrder123: ", existingOrder);

      const tenant = launchpad.tenant as Tenant;
      const domain = `${process.env.NEXT_PUBLIC_APP_URL!}/launchpads/${launchpad.id}`
